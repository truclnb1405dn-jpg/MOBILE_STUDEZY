...
public class SettingsFragment extends Fragment {
  ...
  private void showLogoutDialog() {
      ...
      btnConfirmLogout.setOnClickListener(v -> {
          // 1. CHỈ xóa các dữ liệu liên quan đến phiên đăng nhập (Thay vì dùng clear)
          SharedPreferences sharedPreferences = requireActivity()
                  .getSharedPreferences("StudezyPrefs", Context.MODE_PRIVATE);
          ...
          sharedPreferences.edit()
                  ...
                  .remove("LAST_ACTIVITY_TIME")
                  // Tuyệt đối KHÔNG xóa "SAVED_USERNAME" để giữ lại cho lần sau
                  .apply();
          ...
          // 2. Cài đặt NavOptions để XÓA SẠCH lịch sử các màn hình cũ
          androidx.navigation.NavOptions navOptions = new androidx.navigation.NavOptions.Builder()
                  .setPopUpTo(R.id.nav_graph, true)
                  .build();


          // 3. Chuyển thẳng về trang LoginFragment
