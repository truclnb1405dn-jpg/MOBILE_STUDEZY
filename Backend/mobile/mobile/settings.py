...
SECRET_KEY = 'django-insecure-1hgc6v=7%_e_)1px518zfa7&uo1o@9d%euedx)ayaqopj0lnbg'
...
DATABASES = {
    'default': dj_database_url.config(
        # Nếu đang chạy trên máy tính cá nhân (không có link Render), nó sẽ tự quay về dùng SQLite để bạn dễ code.
        # Khi lên Render, nó sẽ tự động bắt link PostgreSQL.
